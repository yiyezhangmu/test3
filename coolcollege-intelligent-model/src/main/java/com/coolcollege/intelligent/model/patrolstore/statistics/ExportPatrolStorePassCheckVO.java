...
@Data
public class ExportPatrolStorePassCheckVO {
...
//    @Excel(name = "签到时间", orderNum = "0")
    ...
    @Excel(name = "巡店不合格项数", orderNum = "12")
    private Integer failNum;

    @ApiModelProperty(value = "总分值")
    @Excel(name = "总分值", orderNum = "13")
    private BigDecimal totalScore;

    @ApiModelProperty(value = "巡店得分")
    @Excel(name = "巡店得分", orderNum = "14")
...
//    @Excel(name = "稽核状态", orderNum = "17")
    ...
    @Excel(name = "大区稽核得分（值）", orderNum = "19")
