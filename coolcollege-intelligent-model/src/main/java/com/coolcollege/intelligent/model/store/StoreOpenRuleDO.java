 ...
 * @date   2023-05-12 03:53
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class StoreOpenRuleDO implements Serializable {
    @ApiModelProperty("主键")
    private Long id;
    ...
    @ApiModelProperty("区域模式，false：权限模式，true 全区域模式")
