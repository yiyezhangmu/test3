...
@Data
public class AddGroupConfigRequest {
    ...
    public TbWxGroupConfigDO convert(String userId) {
        return TbWxGroupConfigDO.builder()
                .groupName(groupName).pushAddress(pushAddress)
                .createUserId(userId).updateUserId(userId)
                .build();
    }

    public List<TbWxGroupConfigDetailDO> convertListDetail(Long groupId, String userId) {
