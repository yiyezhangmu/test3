 ...
 */
@Data
public class ActivityInfoH5VO implements Serializable {
    ...
    public ActivityInfoH5VO() {
    }

    public ActivityInfoH5VO(Boolean isHaveAuth) {
        this.isHaveAuth = isHaveAuth;
    }

    public static ActivityInfoH5VO convertVO(ActivityInfoDO activityInfo){
        if(Objects.isNull(activityInfo)){
            return null;
        }
        ActivityInfoH5VO result = new ActivityInfoH5VO();
