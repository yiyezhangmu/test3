 ...
 * @FileName: UpdateActivityInfoDTO
 * @Description:
...
public class UpdateActivityInfoDTO {
    ...
    public static ActivityInfoDO convertDO(UpdateActivityInfoDTO param){
        if(Objects.isNull(param)){
            return null;
        }
        ActivityInfoDO result = new ActivityInfoDO();
        result.setId(param.getActivityId());
