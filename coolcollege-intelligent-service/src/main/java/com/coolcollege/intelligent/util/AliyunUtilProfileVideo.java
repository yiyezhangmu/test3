...
import org.slf4j.Logger;
 ...
 /**
  *AliyunUtilProfileVideo, 視頻專用
  * @author jeffrey
  * @date 2022/01/13
  */
 @SuppressWarnings("deprecation")
 public class AliyunUtilProfileVideo implements IClientProfile {
     private static AliyunUtilProfileVideo profile = null;
     ...
     private AliyunUtilProfileVideo() {
     }

     private AliyunUtilProfileVideo(String regionId) {
         this.regionId = regionId;
     }

     private AliyunUtilProfileVideo(String regionId, Credential creden) {
         this.credential = creden;
         this.regionId = regionId;
     }

     private AliyunUtilProfileVideo(String region, ICredentialProvider icredential) {
         this.regionId = region;
         this.icredential = icredential;
     }

     public synchronized static AliyunUtilProfileVideo getProfile() {
         if (null == profile) {
             profile = new AliyunUtilProfileVideo();
         }
         return profile;
     }

     public synchronized static AliyunUtilProfileVideo getProfile(String regionId, ICredentialProvider icredential) {
         profile = new AliyunUtilProfileVideo(regionId, icredential);
         return profile;
     }

     public synchronized static AliyunUtilProfileVideo getProfile(String regionId, String accessKeyId, String secret) {
         Credential creden = new Credential(accessKeyId, secret);
         profile = new AliyunUtilProfileVideo(regionId, creden);
         return profile;
     }
     ...
     public synchronized static AliyunUtilProfileVideo getProfile(String regionId) {
         return new AliyunUtilProfileVideo(regionId);
     }
