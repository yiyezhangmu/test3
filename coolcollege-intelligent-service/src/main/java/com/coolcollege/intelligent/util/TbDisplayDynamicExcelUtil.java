 ...
 */
@Slf4j
public class TbDisplayDynamicExcelUtil {
    // 数据行高和宽度
    ...
    public static List<List<Object>> displayData(List<TbDisplayTaskDataVO> data) {
        List<List<Object>> result = new ArrayList<>();
        for (TbDisplayTaskDataVO datum : data) {
            List<Object> list = new ArrayList<>(24);
            list.add(datum.getStoreAreaName());
            list.add(datum.getStoreName());
            list.add(datum.getTableName());
            list.add(datum.getMetaColumnNum());
            // list.add(datum.getUselessCheckItemNum());
            list.add(datum.getHandleUserName());
            list.add(datum.getApproveUserName());
            list.add(datum.getRecheckUserName());
            list.add(datum.getScore());
            list.add(datum.getRemark());
            list.add(datum.getOverdue());
            list.add(datum.getDoneTime());
            list.add(datum.getCheckTime());
            list.add(datum.getTaskName());
            list.add(datum.getValidTime());
            list.add(datum.getCreateUserName());
            list.add(datum.getCreateTime());
            list.add(datum.getTaskDesc());
            list.add(datum.getStatus());
