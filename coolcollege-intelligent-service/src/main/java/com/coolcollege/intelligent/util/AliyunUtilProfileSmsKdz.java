...
import org.slf4j.Logger;
 ...
 /**
  *酷店掌用AliyunDefaultProfile2, 注意不是数智门店
  * @author jeffrey
  * @date 2022/01/13
  */
 @SuppressWarnings("deprecation")
 public class AliyunUtilProfileSmsKdz implements IClientProfile {
     private static AliyunUtilProfileSmsKdz profile = null;
     ...
     private AliyunUtilProfileSmsKdz() {
     }

     private AliyunUtilProfileSmsKdz(String regionId) {
         this.regionId = regionId;
     }

     private AliyunUtilProfileSmsKdz(String regionId, Credential creden) {
         this.credential = creden;
         this.regionId = regionId;
     }

     private AliyunUtilProfileSmsKdz(String region, ICredentialProvider icredential) {
         this.regionId = region;
         this.icredential = icredential;
     }

     public synchronized static AliyunUtilProfileSmsKdz getProfile() {
         if (null == profile) {
             profile = new AliyunUtilProfileSmsKdz();
         }
         return profile;
     }

     public synchronized static AliyunUtilProfileSmsKdz getProfile(String regionId, ICredentialProvider icredential) {
         profile = new AliyunUtilProfileSmsKdz(regionId, icredential);
         return profile;
     }

     public synchronized static AliyunUtilProfileSmsKdz getProfile(String regionId, String accessKeyId, String secret) {
         Credential creden = new Credential(accessKeyId, secret);
         profile = new AliyunUtilProfileSmsKdz(regionId, creden);
         return profile;
     }
     ...
     public synchronized static AliyunUtilProfileSmsKdz getProfile(String regionId) {
         return new AliyunUtilProfileSmsKdz(regionId);
     }
