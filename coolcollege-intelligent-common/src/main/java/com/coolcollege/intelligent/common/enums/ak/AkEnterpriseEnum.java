 ...
 * @Description: 奥康企业
 */
public enum AkEnterpriseEnum {


    AOKANG("0954c8399b5749c395e1c9e20c028c87","奥康国际"),
    AOKANGPARTNER("798835a93c174ea39344e51bc46b46f1","奥康国际合作伙伴"),
    JOSINY("25ae082b3947417ca2c835d8156a8407","浙江卓诗尼控股有限公司");

    private String code;

    private String message;

    AkEnterpriseEnum(String code, String message) {
        this.code = code;
    ...
    public static Boolean aokangAffiliatedCompany(String eid){
        //判断是否是奥康类型的企业
        for (AkEnterpriseEnum yundaEnterpriseEnum: AkEnterpriseEnum.values()) {
